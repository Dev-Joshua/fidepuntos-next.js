...
export default function TabsContent({ selectedTab }: TabContentProps) {
  return (
    <div
    ...
    >
                  ...
                  <div className='flex flex-row space-x-4'>
                    ...
                    <div className='basis-2/3 w-full '>
                      <h4 className=' text-colordos dark:text-colordosdark'>
                        Redima una noche en habitacion Superior en nuestro Hotel
                        Movich Casa del Alferez en Cali en acomodacion sencilla
                        o doble con desayuno a la carta y amenities superiores.
                      </h4>
                      <p className='mt-2 text-colortres dark:text-colortresdark text-sm'>
                        ...
                        disponible y puntaje aplicable. Una vez redimido, tiene
                        un mes para hacer efectiva su reserva. Previa reserva
                        con mínimo 8 días de anticipación a través del correo
                        electrónico movichdreams@movichhotels.com. Es personal e
                        intransferible. No es redimible por dinero. Toda
                        cancelación de la reserva deberá hacerse con al menos 5
                        días de anticipación de lo contrario se perderá el
                        derecho a utilizar el premio y no se hara devolucion de
                        puntos. Para hacer efectivo el premio es necesario
                        entregar el bono original al momento de ingresar al
                        hotel. No incluye gastos no especificados. El huésped
                        debe cancelar impuestos y seguros hoteleros en el hotel.
                        Al momento de la reserva el huésped debe suministrar
                        datos de la tarjeta de credito como garantia de su
                        reserva. Para mayor información por favor visite los
                        Términos y Condiciones del programa. El presente mensaje
                        no representa aceptación, ni confirmación de reserva
                        para el afiliado, la reserva procesada/confirmada será
                        enviada por medio de nuestro departamento de reservas
                        con las observaciones y/o comentarios pertinentes.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <div
        className={`${
          selectedTab === 'bonos' ? 'block' : 'hidden'
        } p-4 rounded-lg`}
        role='tabpanel'
                ...
                <div className='p-4 md:p-5 space-y-4'>
                  <div className='flex flex-row space-x-4'>
                    ...
                    <div className='basis-2/3 w-full '>
                      ...
                      <p className='mt-2 text-colortres dark:text-colortresdark text-sm'>
                        Condiciones generales: Bono valido por un (1) mes. No es
                        redimible por bebidas alcoholicas. Bono consumible en su
                        totalidad para una sola oportunidad. No es redimible por
                        dinero. No se realizara devolucion de puntos por parte
                        del programa despues de canjeado. Sujeto a
                        disponibilidad del ambiente. Para hacer efectivo el
                        premio es necesario presentar el bono recibido en su
                        cuenta de correo personal a la recepcion del hotel o al
                        area de alimentos y bebidas con el fin de coordinar su
                        entrega y disfrute. Por ser un beneficio expres debe
                        considerar su inmediatez y consultar con el hotel en el
                        cual se encuentra alojado al momento de su redencion. Es
                        personal e intransferible. No incluye gastos no
                        especificados. El huesped debe cancelar adicionales que
                        no estan contemplados en la descripcion de este
                        beneficio. Para mayor informacion por favor visite los
                        Terminos y Condiciones del programa. El presente mensaje
                        representa aceptacion y confirmacion de solicitud para
                        el afiliado y debera ser tramitado por el hotel donde se
                        encuentre alojado siempre que tenga disponibilidad del
                        mismo y se ofrezca este servicio.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <div
        className={`${
          selectedTab === 'gastronomia' ? 'block' : 'hidden'
        } p-4 rounded-lg`}
        role='tabpanel'
        aria-labelledby='gastronomia-tab'
      >
        <div className='grid sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-3 gap-4 pb-4'>
          <select
            id='premioFilter'
              ...
              <div className='relative bg-colorfondo rounded-lg shadow dark:bg-colorfondodark'>
                ...
                <div className='p-4 md:p-5 space-y-4'>
                  <div className='flex flex-row space-x-4'>
                    ...
                    <div className='basis-2/3 w-full '>
                      <h4 className=''>
                        Disfrute de un Almuerzo o Cena sugerencia del chef, de 3
                        tiempos para una (1) persona.
                      </h4>
                      <p className='mt-2 text-colortres dark:text-colortresdark text-sm'>
                        Este beneficio incluye una (1) entrada, un (1) plato
                        fuerte y un (1)postre con una (1) bebida no alcoholica.
                        Condiciones generales: Sujeto a disponibilidad. Para
                        hacer efectivo el premio es necesario presentar el bono
                        recibido en su cuenta de correo personal a la recepcion
                        del hotel o a el area de alimentos y bebidas con el fin
                        de coordinar su entrega y disfrute. Por ser un beneficio
                        expres debe considerar su inmediatez y consultar con el
                        hotel en el cual se encuentra alojado al momento de su
                        redencion. Es personal e intransferible. No es redimible
                        por dinero. No se realizara devolucion de puntos por
                        parte del programa despues de canjeado. No se permite
                        reprogramacion. No incluye gastos no especificados. El
                        huesped debe cancelar adicionales que no esten
                        contemplados en la descripcion de este beneficio. Para
                        mayor informacion por favor visite los Terminos y
                        Condiciones del programa. El presente mensaje representa
                        aceptacion y confirmacion de solicitud para el afiliado
                        y deberá ser tramitado por el hotel donde se encuentre
                        alojado siempre que tenga disponibilidad del mismo y se
                        ofrezca este servicio. Valido para redimir en cualquiera
                        de nuestros hoteles.
                      </p>
                    </div>
                  </div>
        ...
        <div className='grid sm:grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-4 '>
          ...
          >
            <div className='relative w-full max-w-4xl max-h-full'>
              <div className='relative bg-colorfondo rounded-lg shadow dark:bg-colorfondodark'>
                <div className='flex items-center justify-between p-4 md:p-5 border-b rounded-t border-colordosdark dark:border-colordos '>
                  <h2 className=''>Masaje de Espalda y hombros (60 Minutos)</h2>
                  <button
                    type='button'
                    className='text-coloruno bg-transparent hover:bg-colorunodark hover:text-colordos rounded-lg text-sm w-12 h-12 ms-auto inline-flex justify-center items-center dark:hover:bg-black/50 dark:hover:text-colordosdark'
                  ...
                  <div className='flex flex-row space-x-4'>
                    ...
                    <div className='basis-2/3 w-full '>
                      <h4 className=''>
                        ...
                        redimir en cualquiera de nuestros hoteles que tengan el
                        servicio y este se encuentre activo (No Aplica para KUA
                        SPA en Movich Las Lomas Rionegro, Casa del Alferez en
                        Cali, Movich Cartagena).
                      </h4>
                      <p className='mt-2 text-colortres dark:text-colortresdark text-sm'>
                        Condiciones generales: Este beneficio debe ser tomado
                        exclusivamente donde se solicito. Sujeto a
                        disponibilidad. Para hacer efectivo el premio es
                        necesario presentar el bono recibido en su cuenta de
                        correo personal a la recepcion del hotel o a nuestro Spa
                        con el fin de coordinar su entrega y disfrute. Una vez
                        redimido, tiene un mes para hacerlo efectivo en el hotel
                        donde fue solicitado. Por ser un beneficio expres debe
                        considerar su inmediatez y consultar con el hotel en el
                        cual se encuentra alojado al momento de su redencion. Es
                        personal e intransferible. No es redimible por dinero.
                        No se realizara devolucion de puntos por parte del
                        programa despues de canjeado. Solo admite reprogramacion
                        por un periodo de un (1) mes calendario en caso de no
                        poder ser disfrutado. Toda cancelacion/reprogramacion de
                        la redencion debera notificarse por escrito en un
                        periodo no mayor a 5 dias calendario, de lo contrario se
                        perdera el derecho a utilizar el premio y no se hara
                        devolucion de puntos. No incluye gastos no
                        especificados. El huesped debe cancelar adicionales que
                        no esten contemplados en la descripcion de este
                        beneficio. Para mayor informacion por favor visite los
                        Terminos y Condiciones del programa. El presente mensaje
                        representa aceptacion y confirmacion de solicitud para
                        el afiliado y debera ser tramitado por el hotel donde se
